<x-app-layout>
    ...
    <script>
        ...
        window.onafterprint = function() {
            // Configure these values from your backend
            const phoneNumber = "{{ $invitation->recipient_phone }}"; // Add country code
            const invitationName = "{{ $invitation->name }}";
            const message = encodeURIComponent(
                `Here's your invitation for ${invitationName}:\n` +
                'Please present this QR code at the entrance.\n' +
                'Save this PDF and attach it to send through WhatsApp.'
            );
